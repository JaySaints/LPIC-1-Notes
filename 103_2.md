...
- sed '/daemo/d' arquivo-entrada.txt, Exclui as linhas que corresponderem com **daemo**.
- sed 's/regexp/replacement/' arquivo-entrada.txt, Subtistui a parte correspondente **regexp** com o segundo argumento **replacement**. Só será substituido a primeira ocorrencia da linha.
- sed 's/regexp/replacement/**g**' arquivo-entrada.txt, a opção **g** irá substituir todas as ocorrencias da linha.
> _Opções:_
    -i altera o arquivo
...
Fonte:[link](https://terminalroot.com.br/2015/07/30-exemplos-do-comando-sed-com-regex.html)
